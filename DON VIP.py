...
def main():
    ...
    print("{}  | {}DON HACK VIP : {} {}|OWNER V_86Q {}+62-813-6487-3762 {}|").format(r,w,w,w,lgray,w)
    print("{}  '------------------------------------{}-------'  ").format(r,w)
    ...
    print ("  {}[ 9 ] {}Exit DonHack").format(r,w)
    print ""
    select = input("\033[1;31m[ \033[1;37mOWNER : V_86Q \033[1;31m]\033[1;37m> ")
    filtering(select)
