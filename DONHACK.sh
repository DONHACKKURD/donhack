...
'
echo " " 
echo -e "$red                       ▶by$grn @V_86Q$red◀$rset"
echo -e "$red                      ⫸$ylo  DON HACK $red ⫷$rset"
echo 
# Functions
...
loss you do to other's by  V_86Q."
echo
echo -ne "\e[92m#Type exit : "
read exitz
if [ $exitz = "exit" ];
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mV_86Q" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mDON HACK VIP" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.donhack.com\e[0m" | pv -qL 10
