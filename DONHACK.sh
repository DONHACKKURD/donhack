...
banner() {
figlet -f slant "DON HACK VIP" | lolcat
echo "<=====================[✺]====================>" | lolcat
echo "<=====[       TOOL DON HACK VIP       ]=====>" | lolcat
echo  "<=====[  Telegram: @V_86Q.    ]=====>" | lolcat
echo  "<=====[     OWNER : @V_86Q  RODI KURD           ]=====>" | lolcat
echo "<=====================[✺]====================>" | lolcat
...
echo "☆┊𓆩ᴄʏʙᴇʀ ѕᴇᴄᴜʀɪᴛʏ 𖠕𓆪 " | lolcat
echo "☆┊𓆩 𝐀𝐆𝐄   :  19 𓆪 " | lolcat
echo "𓆩 ℕ𝔸𝕄𝔼 : 𝐃𝐎𝐍 𓆪" | lolcat
echo "DON HACK VIP" | lolcat
echo "OWNER : @V_86Q" | lolcat
echo "OWNER : @V_86Q" | lolcat
echo " OWNER : @V_86Q  " | lolcat
